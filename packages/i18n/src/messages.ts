...
export const messages = {
  ru: {
    ...
    "setup.wizard.branch.subtitle": "В этом клубе несколько филиалов. Укажите, в каком из них стоит этот компьютер.",
    ...
    "setup.wizard.device.field.name": "Имя компьютера",
    ...
    "setup.wizard.finished.pending.body": "Откройте панель клуба и подтвердите этот компьютер, после этого Agent начнёт принимать команды.",
    ...
    "setup.wizard.finished.pendingNote": "Пока статус Pending, Agent не будет запускаться. Подтвердите устройство в панели, затем перезапустите этот компьютер.",
