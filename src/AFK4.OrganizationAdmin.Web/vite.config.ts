...
// inert/absent in the production build. Lets the Organization Admin UI run in a plain browser against
...
// window.__AFK4_ORGANIZATION_ADMIN_CONFIG__, so `bun run build` needs VITE_PLATFORM_BASE_URL set in the
