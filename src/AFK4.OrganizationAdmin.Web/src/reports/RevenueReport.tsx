...
export function RevenueReport({ backend }: { backend: OperatorBackendContext | null; currencyCode: string }): JSX.Element {
  ...
  return <ManagementScreen title={t('op.reports.revenue.title')} subtitle={t('op.reports.revenue.subtitle')} contentWidth="full" state={state} failure={error} onRetry={() => void load()}>
