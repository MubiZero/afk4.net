...
// возможностей — оно просто врёт. Перезагрузка, выключение, пробуждение, обслуживание, сообщение и
// выход игрока живут в карточке места (PcCommands): опасное там спрашивает «точно?», а сообщению
// нужен текст — ни то ни другое не помещается в пункт меню, который исполняется сразу.
