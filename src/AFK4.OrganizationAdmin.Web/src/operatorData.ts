...
export interface SeatSummary {
  ...
  zoneId?: string | null;
  // Когда с места позвали оператора. Null — не зовут. Время, а не флаг: стойке важно, кто ждёт
  // дольше, а не просто «кто-то зовёт».
  assistanceRequestedAtUtc?: string | null;
  // Состояние сессии с сервера как есть. Тон плитки его огрубляет (пауза и игра одинаково
  // «заняты»), а действиям нужна разница: паузу снимают, а не ставят второй раз.
