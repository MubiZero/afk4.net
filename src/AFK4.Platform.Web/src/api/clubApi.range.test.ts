...
describe('getDashboardSummaryForRange', () => {
  it('passes explicit fromUtc/toUtc query params', async () => {
    const fetchImpl = mock().mockResolvedValue(new Response('{}', { status: 200 }));
    ...
    await client.branches.getDashboardSummaryForRange('b1', '2026-05-20T00:00:00.000Z', '2026-05-20T23:59:59.000Z');
