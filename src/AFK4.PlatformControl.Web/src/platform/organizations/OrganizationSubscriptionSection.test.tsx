...
const sub: OrganizationSubscription = {
  organizationSubscriptionId: 's', organizationId: 'o', planCode: 'starter', status: 'active',
...
describe('OrganizationSubscriptionSection', () => {
  it('loads and shows the current plan', async () => {
    render(<I18nProvider><ToastProvider><OrganizationSubscriptionSection client={fakeClient()} plans={fakeClient()} organizationId="o" /></ToastProvider></I18nProvider>);
