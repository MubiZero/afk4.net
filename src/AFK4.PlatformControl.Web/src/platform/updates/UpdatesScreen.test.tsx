...
function setup(state: string = 'registered', rollouts: unknown[] = [], { packages = [{ ...packageRow, state }], canRegisterPackages = true }: { packages?: unknown[]; canRegisterPackages?: boolean } = {}) {
  const updates = {
