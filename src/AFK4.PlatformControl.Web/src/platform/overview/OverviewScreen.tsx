  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-6">
        <Kpi label={t('platform.overview.kpi.organizations')} value={formatNumber(kpis.totalOrganizations)} />
        <Kpi label={t('platform.overview.kpi.active')} value={formatNumber(kpis.activeOrganizations)} />
        <Kpi label={t('platform.overview.kpi.suspended')} value={formatNumber(kpis.suspendedOrganizations)} />
        <Kpi label={t('platform.overview.kpi.trial')} value={formatNumber(kpis.trialOrganizations)} />
        <Kpi label={t('platform.overview.kpi.branches')} value={formatNumber(kpis.totalBranches)} />
        <Kpi label={t('platform.overview.kpi.new30d')} value={formatNumber(kpis.newOrganizations30d)} />
      </div>
