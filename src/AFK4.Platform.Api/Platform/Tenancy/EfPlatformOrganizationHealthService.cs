    ...
    TimeProvider timeProvider) : IPlatformOrganizationHealthService
{
    ...
    public async Task<OrganizationHealthDto?> GetAsync(Guid organizationId, CancellationToken cancellationToken)
    {
        ...
        var recentErrors = recentErrorEntities
            .Select(record => new OrganizationHealthErrorDto(
        ...
        return new OrganizationHealthDto(
