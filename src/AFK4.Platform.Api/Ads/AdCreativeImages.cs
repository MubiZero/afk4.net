...
/// <summary>
/// Копия картинки одобренного креатива (спека рекламы, §8.1): закон велит хранить показанную рекламу
/// год (ст. 22), а показывать надо ровно то, что одобрил модератор, — не то, что лежит по ссылке
/// рекламодателя сегодня.
/// </summary>
