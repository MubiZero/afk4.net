...
internal static class ReservationHoldCauses
{
    ...
    /// <summary>
    /// Бронь перенесли, и её цена пересчитана. Старая заморозка снимается целиком, новая ставится
    /// на новую сумму: держать заморозку под вчерашнюю цену значит однажды посадить человека за
