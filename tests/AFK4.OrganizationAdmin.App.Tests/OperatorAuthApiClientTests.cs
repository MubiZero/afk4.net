...
public sealed class OperatorAuthApiClientTests
{
    ...
    public async Task SignInAsync_PostsCredentialsAndSavesTokenSnapshot()
    {
        ...
        var tokenStore = new RecordingOrganizationAdminTokenStore();
    ...
    public async Task RefreshAsync_UsesStoredOrganizationAndSavesRotatedTokens()
    {
        ...
        var tokenStore = new RecordingOrganizationAdminTokenStore
        {
            SavedSnapshot = new OrganizationAdminTokenSnapshot(
                StaffUserId,
                OrganizationId,
                "Cashier One",
                "old-access-token",
    ...
    private sealed class RecordingOrganizationAdminTokenStore : IOrganizationAdminTokenStore
    {
        public OrganizationAdminTokenSnapshot? SavedSnapshot { get; set; }
