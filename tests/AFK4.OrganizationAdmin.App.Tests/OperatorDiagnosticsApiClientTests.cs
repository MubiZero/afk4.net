...
public sealed class OperatorDiagnosticsApiClientTests
{
    ...
    private static HttpOperatorDiagnosticsApiClient CreateClient(RecordingHttpMessageHandler handler)
    {
        ...
        return new HttpOperatorDiagnosticsApiClient(httpClient, new StaticOrganizationAdminTokenStore());
    }
    ...
    {
        public Task SaveAsync(OrganizationAdminTokenSnapshot snapshot, CancellationToken cancellationToken) => Task.CompletedTask;
