...
public sealed class OrganizationAdminTokenStoreTests
{
    [Fact]
    public async Task SaveAsync_ThenLoadAsync_ReturnsStoredTokenSnapshotWithoutPlaintextTokens()
    {
        ...
        var store = new ProtectedDataOrganizationAdminTokenStore(path);
        var snapshot = new OrganizationAdminTokenSnapshot(
