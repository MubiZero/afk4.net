...
public sealed class TenantHealthContractSerializationTests
{
    [Fact]
    public void TenantHealthDto_RoundTripsRecentErrors()
    {
        var health = new TenantHealthDto(
        ...
        var copy = JsonSerializer.Deserialize<TenantHealthDto>(json);
