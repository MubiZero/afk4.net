...
- [ ] **Step 2: Restore and build the Operator Web assets**
...
- [ ] **Step 4: Build and test the native Operator host**
...
- [ ] **Step 1: Create a fresh tenant and accept its owner invite through public APIs**
...
- [ ] **Step 2: Seed branch prerequisites through staff APIs**
...
- [ ] **Step 3: Verify the starting invariant**
...
- [ ] **Step 1: Launch the real native host against staging**
...
- [ ] **Step 2: Prove page identity and runtime health**
...
- [ ] **Step 3: Complete the critical interaction path**
...
- [ ] **Step 4: Exercise desktop behavior**
...
- [ ] **Step 1: Record one root-cause hypothesis per defect**
...
- [ ] **Step 1: Run blast-radius verification**
...
- [ ] **Step 2: Self-review and update durable docs**
...
- [ ] **Step 4: Merge only after latest-head verification is green**
