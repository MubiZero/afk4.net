...
- `2026-09-24-player-shell-rewrite-design.md` — Player Shell с нуля: экраны и состояния,
  канал агент ↔ хост v2, вход через устройство и по QR, токены, привязанные к ПК, цены до
  нажатия, витрина, киоск на Windows (учётка с автовходом, перехват клавиш, профили защиты,
  обслуживание), движение и цена кадра, нарезка на планы P1–P9. Требования — PRD §6, порядок —
  roadmap «Launch Scope».
