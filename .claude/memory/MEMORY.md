...
- [Волна D — продуктовые операции](platform-product-operations-wave-d.md) — спека на 5 планов; планы 1 «лимиты» (#143), 2 «фичи» (#144) и половина 3 «роли» (#145, задачи 1-2 из 5) в main; анонсы/офбординг не начаты; лестница «исключение→тариф→умолчание», `plan_features` пуст намеренно, платёж в полёте зачисляется осознанно.
