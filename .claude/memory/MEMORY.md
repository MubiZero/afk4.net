...
- [Operator «Клиенты» (Этап 3)](afk4-operator-clients-epic.md) — Подход A (master-detail), слайсы S0/S1/S1b смержены (PR #103/#104/#105), **S2 power-tools в PR #106**; дальше S3 (правка профиля+деактивация, новый бэкенд PATCH).
