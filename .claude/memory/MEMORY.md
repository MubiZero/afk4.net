...
- [Аудит Оператора 2026-08](operator-audit-backlog-2026-08.md) — **пункты 1-2 ЗАКРЫТЫ** (PR #150): баг POS с авто-товаром и «Сеть → Обновления» вместо пропавшего окна обновления. Осталось: ~1050 строк мёртвого кода + 261 осиротевший ключ `op.settings.*`, 26 отключённых тестов в App.test, к мобиле вёрстка не готова (медиа-запросы в 11 CSS из 27).
