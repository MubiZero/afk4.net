...
- [Волна D — продуктовые операции](platform-product-operations-wave-d.md) — спека на 5 планов; план 1 «лимиты тарифа» в main (#143), фичи/роли/анонсы/офбординг не начаты; лимиты были полу-имплементацией, второго филиала в продукте не существовало.
