...
- [Волна C — наблюдение платформы за собой](platform-observability-wave-c.md) — здоровье заданий, инциденты, оповещения (PR #140 в main); аналитика и история клуба не начаты; четыре Critical были дефектами плана, не исполнителей.
