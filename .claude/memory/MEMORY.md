...
- [Волна C — наблюдение и аналитика](platform-observability-wave-c.md) — здоровье/инциденты/оповещения (PR #140) + бизнес-аналитика (PR #141) в main; история клуба не начата; дефекты обеих веток были в планах, не у исполнителей.
