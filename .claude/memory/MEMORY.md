...
- [Волна D — продуктовые операции](platform-product-operations-wave-d.md) — спека на 5 планов; планы 1 «лимиты» (#143), 2 «фичи» (#144), 3 «роли» (#145+#146) в main; остались анонсы и офбординг; лестница «исключение→тариф→умолчание», `plan_features` пуст намеренно, платёж в полёте зачисляется осознанно.
