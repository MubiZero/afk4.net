...
- [Аудит Оператора 2026-08](operator-audit-backlog-2026-08.md) — по коду: **баг POS кладёт первый товар в чек**, пропало окно обновления клуба (бэкенд жив, UI нет), ~1050 строк мёртвого кода + 261 осиротевший ключ, 26 отключённых тестов в App.test, к мобиле вёрстка не готова.
