...
- [Волна D — продуктовые операции](platform-product-operations-wave-d.md) — спека на 5 планов; планы 1 «лимиты» (#143) и 2 «фичи» (#144) в main, роли/анонсы/офбординг не начаты; лестница «исключение→тариф→умолчание», `plan_features` пуст намеренно, платёж в полёте зачисляется осознанно.
