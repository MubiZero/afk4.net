...
- [Аудит Оператора 2026-08](operator-audit-backlog-2026-08.md) — **пункты 1-4 и 6 ЗАКРЫТЫ** (#150 баг POS + окно обновления, #151 мёртвый код и 816 ключей, #152 отключённые тесты, #153 гонка старта сессии, #154 мелкие долги). Осталось: **выгрузка журнала** (быстро) и **мобильная обёртка** (крупно). Durable: терминологический долг сведён наполовину — досводить по ВСЕМ языкам; тесты Оператора гонять `bun run test`, не `bun test`.
