...
- [Аудит Оператора 2026-08](operator-audit-backlog-2026-08.md) — **пункты 1-4 ЗАКРЫТЫ** (#150 баг POS + окно обновления, #151 мёртвый код и 816 ключей, #152 отключённые тесты). Осталось: мобильная вёрстка, мелкие долги, выгрузка журнала (возможно потеряна). Durable: динамические ключи `roles.${}` наивный поиск не видит; `tsc` страхует удаление ключей.
