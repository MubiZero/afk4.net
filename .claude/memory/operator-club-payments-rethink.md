...
metadata: 
  ...
  modified: 2026-07-21T11:18:38.427Z
---
...
3. **Платежи/Лояльность:** структурная расшивка из табов — в main (84aa3a8b). **ВИЗУАЛЬНЫЙ РЕДИЗАЙН
   /interface-limb — СДЕЛАН начисто И ВИЗУАЛЬНО ПРИНЯТ юзером (ветка `feat/operator-payments-loyalty-onepage`,
   изменения НЕ закоммичены — ждут отмашки на commit/merge).** Durable-урок (3 захода): (1) band+зоны поверх форм → «полная хуйня»;
